    ...
    <div className="min-h-screen bg-black pt-32 pb-24">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div className="mt-12 p-6 border border-[#1A1A1A] bg-[#0A0A0A]">
          ...
          <p className="text-sm text-white">{t("contactCompany")}</p>
          <p className="text-sm text-[#A3A3A3]">{t("contactCui")}</p>
          <p className="text-sm text-[#A3A3A3]">{t("contactAddress")}</p>
          <p className="text-sm text-[#A3A3A3]">{t("contactDetails")}</p>
        </div>
      </div>
    </div>
  );
